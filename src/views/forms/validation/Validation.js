  ...
  return (
    <CForm className="row g-3 needs-validation" validated={validated} onSubmit={handleSubmit}>
      ...
      <CCol md={4}>
        ...
        <CInputGroup className="has-validation">
          <CInputGroupText id="inputGroupPrepeD02">@</CInputGroupText>
          <CFormInput
            type="text"
            id="validationDefaultUsername"
            defaultValue=""
            aria-describedby="inputGroupPrepeD02"
            required
          />
          <CFormFeedback invalid>Please choose a username.</CFormFeedback>
        </CInputGroup>
            ...
            <DocsExample href="forms/validation#server-side">
              <CForm className="row g-3 needs-validation">
                ...
                <CCol md={4}>
                  ...
                  <CInputGroup className="has-validation">
                    <CInputGroupText id="inputGroupPrepeD03">@</CInputGroupText>
                    <CFormInput
                      type="text"
                      id="validationServerUsername"
                      defaultValue=""
                      aria-describedby="inputGroupPrepeD03"
                      invalid
                      required
                    />
                    <CFormFeedback invalid>Please choose a username.</CFormFeedback>
